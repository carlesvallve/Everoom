...
public class Hud : MonoBehaviour {
  ...
  public void ToggleUi() {
    ...
    Component[] rectTransforms = GetComponentsInChildren<RectTransform>(true);
    foreach (Transform tr in rectTransforms) {
      if (tr.gameObject.name == "Hud" || tr.gameObject.name == "ButtonUi") { continue; }
      tr.gameObject.SetActive(uiEnabled);
    }
  }
